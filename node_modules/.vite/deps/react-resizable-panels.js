...
function Ut({
  ...
  const x = (0, import_react.useRef)({
    ...
    V(x.current.onLayoutChange, b) || (x.current.onLayoutChange = b, a == null ? void 0 : a(b));
  }), p = oe((b) => {
    V(x.current.onLayoutChanged, b) || (x.current.onLayoutChanged = b, u == null ? void 0 : u(b));
  ...
  const M = oe(
    (b, w) => {
      ...
      if (n == null ? void 0 : n[w])
        return {
          flexGrow: n == null ? void 0 : n[w]
        };
    }
  ), C = Le({
    defaultLayout: n,
