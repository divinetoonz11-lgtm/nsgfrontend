        ...
        <Router>
          <AuthProvider>
            ...
            <Routes>
              ...
              {/* Associate Routes - Protected with requireRole="associate" */}
              <Route 
                path="/associate-dashboard" 
                element={
                  <ProtectedRoute requireRole="associate">
                    <AssociateDashboard />
                  </ProtectedRoute>
                } 
              />
              <Route 
                path="/associate/referral" 
                element={
                  <ProtectedRoute requireRole="associate">
                    <ReferralPage />
                  </ProtectedRoute>
              ...
              {/* Customer Routes - Protected with requireRole="customer" */}
              <Route 
